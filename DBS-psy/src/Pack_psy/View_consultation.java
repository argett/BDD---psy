...
public class View_consultation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        inPrix = new javax.swing.JTextField();
        ...
        inPrix.setText("0.00");
        inPrix.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                inPrixActionPerformed(evt);
            }
        });
        ...
        btn_addRDV.setText("Update Consultation");
        ...
        btn_annuler.setBackground(new java.awt.Color(220, 140, 142));
        btn_annuler.setText("Annuler Consultation");
    ...
    private void inPrixActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inPrixActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_inPrixActionPerformed
    ...
    private void fillComponents() throws ClassNotFoundException, SQLException{
        ...
        initRow=modelCur.getRowCount();
        
        String getValues = "SELECT * FROM Consultations WHERE consultationid= '"+cid+"';";
        rs = connex.getStatement().executeQuery(getValues);
        rs.next();
        
        Date dateTime=rs.getTimestamp("horaire");
        
        inDate.setText(ymdFormat.format(dateTime));
        inHoraire.setText(timeFormat.format(dateTime));
        inPrix.setText(rs.getString("prix"));
        inType.setText(rs.getString("typerdv"));
        String anxiete = rs.getString("Anxiete");
        if(anxiete == null) {
            cbox_anxiete.setSelectedIndex(0);
        } else{
    ...
    private void btn_addRDVMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_addRDVMouseClicked
        ...
        try {
            ...
            String prix= String.valueOf(inPrix.getText());
            ...
            if(Double.parseDouble(prix)<0)
            {
                ...
                String updateRdv = "UPDATE Consultations SET horaire = '"+horaire+"', prix = "+prix+", reglement = '"+reglement+"'"+ anxiete + 
                        " WHERE consultationid = '" + cid + "';";
                if(stmt.executeUpdate(updateRdv)==0)
                {
                    ...
                    for(int i=initRow; i< modelCur.getRowCount() ; i++)
                    {
    ...
    private void btn_annulerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_annulerMouseClicked
        ...
        try{
            if(stmt.executeUpdate("DELETE FROM Consultations WHERE consultationid = '"+cid+"';") != 0)
            {
                this.dispose();
            }
        } catch (SQLException ex) {
